...
const CHASE_SPEED := 88.0         # px/s the mob chases — clearly slower than the player (130) so you can outrun it
const RETURN_SPEED := 100.0       # px/s it walks back to spawn after de-aggro
